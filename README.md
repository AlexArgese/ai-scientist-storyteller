...
The dataset used in the experiment of the paper are downloadable from [Zenodo](https://zenodo.org/records/18986043).
It should be added in the `datasets/` folder (not versioned).
Small heads are provided under `data-samples/` to illustrate format.
